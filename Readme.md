...
%The raw data is collected using a Trimble NetR9 GNSS receiver with a frequency of 1Hz and a 50Hz Tamagawa-seiki TAG264 IMU. In addition, we have ground truth from a mature satellite navigation system called Applanix POS LV620 (10Hz). The entire data collection process lasts about 20 minutes, which contains 12410 data samples.
